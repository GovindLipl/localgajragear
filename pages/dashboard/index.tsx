...
export default function Dashboard() {
  ...
  const fetchCustomers = async () => {
    await backendGetDashboards().then((res) => {
      if (!res.isError) {
        const { customers , transactions, pendingApproval, approvedRedeemption, redeemptions, coupons, activeCustomers } = res.data
          ...
          <Card className='prod-p-card bg-white'>
            <Card.Body className='p-20'>
              <Row className='align-items-center'>
                ...
                <Col xl={9} sm={9} xs={9}>
                  <h6 className="m-b-5 text-dark">Total Mechanics</h6>
          ...
          <Card className='prod-p-card bg-white'>
            <Card.Body className='p-20'>
              <Row className='align-items-center'>
                ...
                <Col xl={9} sm={9} xs={9}>
                  <h6 className="m-b-5 text-dark">Active Mechanics</h6>
